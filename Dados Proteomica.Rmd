...
```{r graf2}
ggplot(topP, aes(x=logFC, y=(-10*log(adj.P.Val)), col=((abs(logFC)>1)&(adj.P.Val<0.05)))) + geom_point() + geom_vline(xintercept = c(-1,1)) + geom_hline(yintercept = 200) + ylab("-10*log(p-valor)") + theme(legend.position="none")
```

```{r}
ggplot(topP, aes(x=logFC, y=(-(10*log(adj.P.Val))), col=(abs(topP$logFC>1)|((-10*log(topP$adj.P.Val))>200)))) + geom_point() + geom_vline(xintercept = c(-1,1)) + geom_hline(yintercept = 200)  + ylab("-10*log(p-valor)") + theme(legend.position="none")
```
